...
import type { CompletionEstimate, Course, DirectMessage, Enrollment, InstructorGuidance, LearnerSnapshot, OfficeHour, PublicUser, RiskFactor, Thread } from '../../shared/types';
...
export function LearnerPortal({ userId, courseId }: { userId: string; courseId?: string }) {
  ...
  const home = { items: data.items, officeHours: data.officeHours, messages: data.messages, feedbackDue: false };
  return (
    <div>
