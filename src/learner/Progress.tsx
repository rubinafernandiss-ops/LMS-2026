...
function MetricsCard({ item }: { item: CourseItem }) {
  ...
  const rows = [
    ...
    { name: 'Interaction depth', what: 'Quizzes, activities, questions, and live sessions', value: pct(e.engagementScore), goal: '70% or more', st: status(e.engagementScore, 70, 45) },
  ];
  return (
